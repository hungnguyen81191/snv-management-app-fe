<template>
  ...
  >
    ...
    >
      ...
      <div class="h-auto min-w-full bg-cyan-100 ">
        <table class="items-center justify-center block rounded-lg ">
          <thead class="">
            <tr class="">
                ...
                >
                  <div class="sm:flex sm:items-start">
                    ...
                    <div class="mt-3 text-center sm:mt-0 sm:ml-4 sm:text-left">
                      <DialogTitle
                        as="h3"
                        class="text-lg font-medium leading-6 text-gray-900 items-center justify-center"
                      >
                        Create new Okr
                      </DialogTitle>
                      <div class="mt-2">
      ...
      <div class="-mx-4 -my-2 overflow-x-auto sm:-mx-6 lg:-mx-8">
        <div class="inline-block min-w-full py-2 align-middle md:px-6 lg:px-8">
          <div
            ...
            "
          >
            <table class="min-w-full divide-y divide-gray-300 px-8">
